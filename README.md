...
3. Initialize CAN and the SD card either way. If the clock was synced (from either network), open (or resume appending to) `/data.csv` and start writing rows to SD.
